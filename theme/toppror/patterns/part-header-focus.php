 ...
 * Slug: toppror/part-header-focus
 * Inserter: no
 *
...
<!-- wp:paragraph {"align":"right","className":"to-focus-phone","style":{"typography":{"lineHeight":"1.3"}},"fontSize":"small"} -->
<p class="has-text-align-right to-focus-phone has-small-font-size" style="line-height:1.3"><span class="to-hide-mobile">Frågor? </span><a href="tel:<?php echo esc_attr( to_lead( 'telefon_tel' ) ); ?>"><strong><?php echo esc_html( to_lead( 'telefon' ) ); ?></strong></a></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
