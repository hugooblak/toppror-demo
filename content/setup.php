<?php
/**
 * Demo site setup for Topp-Rör AB.
 *
 ...
 * Site settings
 * ----------------------------------------------------------------------- */
update_option( 'blogname', 'Topp-Rör AB' );
...
nps_page(
	'takomlaggning',
	'Takomläggning',
	nps_pattern( 'toppror/page-replacement' ),
...
nps_page(
	...
	nps_pattern( 'toppror/page-storm' ),
...
$quote = nps_page(
	'offert',
	'Boka besiktning',
	nps_pattern( 'toppror/quote-funnel' ),
...
<p class="has-large-font-size">Topp-Rör AB är ett familjeföretag från Sollentuna. Vi startade 1996 med en bil och en regel vi fortfarande håller oss till: priset vi skriver ner är priset du betalar.</p>
<!-- /wp:paragraph -->
...
<!-- /wp:list -->
HTML;
nps_page( 'om-oss', 'Om Topp-Rör AB', $about_content . "\n\n" . nps_pattern( 'toppror/cta-inline' ), 'Familjeägt takföretag i norra Stockholm sedan 1996. Egna montörer, fasta priser skriftligt och 10 års garanti.' );
...
nps_page( 'vanliga-fragor', 'Vanliga frågor', $faq_content . "\n\n" . nps_pattern( 'toppror/cta-inline' ), 'Svar om offert, pris, ROT-avdrag, hur lång tid en takomläggning tar och vad garantin täcker.' );
...
<!-- /wp:paragraph -->
HTML;
$privacy = nps_page( 'integritetspolicy', 'Integritetspolicy', $privacy_content, 'Så använder Topp-Rör AB uppgifterna du skickar med offertformuläret.' );
...
nps_log( 'Topp-Rör AB demo ready.' );
